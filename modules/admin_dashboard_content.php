...
$pending_ingredients = mysqli_fetch_assoc(mysqli_query($dbc, "SELECT COUNT(*) as cnt FROM order_checklist WHERE is_ready = 0"))['cnt'];
// Orders Awaiting Payment
$awaiting_payment = mysqli_fetch_assoc(mysqli_query($dbc, "SELECT COUNT(*) as cnt FROM orders WHERE payment_status = 'unpaid' AND payment_method != 'gcash'"))['cnt'];
...
// Number of customers
$customer_count = mysqli_fetch_assoc(mysqli_query($dbc, "SELECT COUNT(*) as cnt FROM users"))['cnt'];
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center border-warning">
                <div class="card-body">
                    <h6 class="card-title">Pending Ingredients</h6>
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center border-info">
                <div class="card-body">
                    <h6 class="card-title">Orders Awaiting Payment</h6>
